...
export enum Operator {
  ...
  // cosine possible value ranges: 1 - 0 - (-1) === 1 equal vectors angle of 0pi, 0 orthogonal vectors pi halfs, -1 inverse vectors pi 
...
export class FilterOperator extends EnumValueObject<Operator> {
  ...
  static fromValue(value: string): FilterOperator {
    switch (value) {
      ...
      case Operator.COSINE_DISTANCE:
        return new FilterOperator(Operator.COSINE_DISTANCE);
      default:
